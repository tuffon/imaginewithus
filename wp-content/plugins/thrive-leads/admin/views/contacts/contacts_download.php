											...
											<div class="tvd-col tvd-s3">
												<div class="tvd-right">
													<?php if ( $item->status == 'complete' ): ?>
														<a href="<?php echo $item->download_link; ?>" class="tvd-btn-icon tvd-btn-icon-green tvd-no-load">
													...
													<?php if ( $item->status == 'complete' || $item->status == 'error' ): ?>
														<a data-id="<?php echo $item->id; ?>" class="tvd-btn-icon tvd-btn-icon-red tve-delete-download tvd-pointer">
...
<div id="tve-leads-delete-contact" class="tvd-modal">
	...
	<div class="tvd-modal-footer">
		<div class="tvd-row">
			...
			<div class="tvd-col tvd-s12 tvd-m6">
				<a href="" class="tvd-waves-effect tvd-waves-light tvd-btn tvd-btn-red tve-modal-delete-contact tvd-right">
