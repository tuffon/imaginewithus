...
<ul id="tl-leads-submenu" class="tvd-dropdown-content">
	<li <?php if ( $current_screen->base == "thrive-leads_page_thrive_leads_asset_delivery" ) {
	...
	<li <?php if ( $current_screen->base == "thrive-leads_page_thrive_leads_contacts" ) {
		echo 'class="tl-leads-current-item-sub"';
	} ?>>
...
<ul class="tvd-right">
	<li <?php if ( $current_screen->base == "thrive-leads_page_thrive_leads_reporting" ) {
	...
	<li <?php if ( $current_screen->base == "thrive-leads_page_thrive_leads_asset_delivery" || $current_screen->base == "thrive-leads_page_thrive_leads_contacts" ) {
		echo 'class="tl-leads-current-item"';
	} ?>>
