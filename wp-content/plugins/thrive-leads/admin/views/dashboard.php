				...
				<div class="nav-wrapper">
					<div class="tve-logo">
						<a href="<?php menu_page_url( 'thrive_leads_dashboard' ); ?>"
						   class="tl-leads-users-dashboard-logo"
					...
					<div class="hide-no-groups">
						<div class="tvd-group-header">
							<div class="tvd-row">
								...
								<div class="tvd-col tvd-s2">
									<div class="tvd-truncate-on-small"
									     data-popup="<?php echo __( 'Display Status', 'thrive-leads' ) ?>">
										<h5 class="tvd-truncate-on-small-el"><?php echo __( 'Display Status', 'thrive-leads' ) ?></h5>
									</div>
								</div>
								<div class="tvd-col tvd-s2">
									<h5>&nbsp;</h5>
