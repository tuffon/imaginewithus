...
function tve_dash_enqueue() {
	...
	tve_dash_enqueue_script( 'tve-dash-main-js', TVE_DASH_URL . '/js/dist/tve-dash' . $js_suffix, array( 'jquery', 'backbone' ) );
 ...
 */
function tve_dash_output_backbone_templates( $templates ) {
