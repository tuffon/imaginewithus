...
function tve_leads_get_screen_data()
{
    ...
    $screen_data[0]['name'] = "Thrive Leads";
    $screen_data[0]['url'] = menu_page_url("thrive_leads_dashboard", false);
    $screen_data[1]['name'] = str_replace('Thrive Leads ', '', get_admin_page_title());
    $screen_data[1]['url'] = $url;
    $screen_data[1]['last'] = 1;
